...
Saiba que, o empréstimo só pode ser concedido se o valor da parcela for menor ou igual a 30% do salário do cliente.
Você deve utilizar o cálculo de juros compostos, por exemplo, em um empréstimo no valor de R$ 10000,00 em 10 parcelas,
...
public class MainActivity extends AppCompatActivity {
    ...
    private String nome;
    private double salario, valorParcela, porcentagem;
    private int parcela, emprestimo, juros;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                calcularParcela(emprestimo, parcela);
                calulcarPorcentagem(salario, valorParcela);
              //  Toast.makeText(getApplicationContext(), "%: "+ porc, Toast.LENGTH_LONG).show();

                if(porcentagem < 30){
                    Toast.makeText(getApplicationContext(), "Emprestimo: valor total: "+emprestimo+" qtd parcelas: "+parcela+" valor parcela: "+valorParcela+ "porcentagm: "+porcentagem, Toast.LENGTH_LONG).show();
                }else{
    ...
    private void converterDados() {
        ...
        parcela = Integer.parseInt(parcelastxt.getText().toString());
        emprestimo =  Integer.parseInt(emprestimotxt.getText().toString());
        juros =  Integer.parseInt(jurostxt.getText().toString());
    }
